...
const Contact = () => {
 ...
 const handleSubmit = (e) => {
  ...
  emailjs.send(
    ...
    to_email: 'ali0936781321@gmail.com',
   ...
   .then(() => {
    setLoading(false);
    alert('thank you i well call back as soon as possible');
    ...
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
     ...
     className="flex-[0.75px] bg-black-100 p-8 rounded-2xl">
      ...
      <label className="flex flex-col">
        ...
        <textarea rows="7" name="message" value={form.message} onChange={handleChange} placeholder="What do you to say"
        className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none" />
      </label>
